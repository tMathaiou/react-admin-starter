...
const Loader = () => {
  ...
  const spinnerDelay1 = useMemo(() => ({ animationDelay: '0.1s' }), [])
  const spinnerDelay2 = useMemo(() => ({ animationDelay: '0.2s' }), [])
  const spinnerDelay3 = useMemo(() => ({ animationDelay: '0.3s' }), [])
  const spinnerDelay4 = useMemo(() => ({ animationDelay: '0.4s' }), [])
  const spinnerDelay5 = useMemo(() => ({ animationDelay: '0.5s' }), [])
